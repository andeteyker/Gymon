import { ExerciseBaseline, ExerciseDefinition, MuscleGroup, WorkoutReward, WorkoutSession, WorkoutSet } from "./types";
...
export function evaluateWorkout(session:WorkoutSession,definitions:ExerciseDefinition[],baselines:ExerciseBaseline[]):WorkoutReward{
 ...
 const improvement=relativeImprovement(totalCurrent,totalBaseline); const xp=progressionXp(improvement,completedSets);
 ...
 return {xp,relativeImprovement:improvement,muscleXp,completedSets};
}
